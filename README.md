...
| `configuration.nix` | System level: bootloader, locale/timezone, greetd + ReGreet login, GNOME/Niri sessions, audio (PipeWire), fonts, OpenSSH, Tailscale, user account, system packages. |
